...
export const UsageIconColors: [string, string, string, string] = [
  "#47B39C",
  "#FFC154",
  "#EC6B56",
  "#BE2525",
...
export const BarComparisionColors: string[] = ["#177AD5", "#ED6665", "#8BC34A"];

export const SuccessColor: { light: string; dark: string } = {
  light: "#307743",
  dark: "#d2ffda",
};
