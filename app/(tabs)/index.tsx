  ...
  const sections = [
    {
      data: [
        {
          id: 1,
          node: <BudgetGraph currentBudget={currentBudget} isActive={true} />,
        },
      ],
    },
    {
      data: [
        {
          id: 2,
          node: <IncomeSection currentBudget={currentBudget} isActive={true} />,
        },
      ],
    },
    {
      data: [
        {
          id: 3,
          node: (
            <ExpenseSection currentBudget={currentBudget} isActive={true} />
          ),
        },
      ],
    },
